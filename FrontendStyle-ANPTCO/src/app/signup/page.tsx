    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="bg-white rounded-xl p-8 border border-gray-200 shadow-sm w-full max-w-md">
        ...
        <div className="space-y-3">
          {[
            { label: '🏭 Client',           sub: 'Order fuel and manage deliveries', path: '/auth/signup/client'    },
            ...
            >
              <div className="font-semibold text-gray-800 group-hover:text-blue-600">{label}</div>
